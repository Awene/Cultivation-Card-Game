  ...
  const $style = $('<style>')
    ...
    .text(`
      .cultivation-workshop-launcher {
        ...
        border: 2px solid rgba(190, 151, 84, .72); border-radius: 50%;
        color: #fff8e8; background:
          radial-gradient(circle at 32% 25%, rgba(255, 226, 174, .4), transparent 46%),
          linear-gradient(145deg, #b94b43 0%, #84282b 58%, #491418 100%);
        box-shadow: 0 0 18px rgba(151, 48, 47, .46), inset 0 2px 4px rgba(255,255,255,.22),
          inset 0 -4px 7px rgba(42,8,10,.55), 0 7px 18px rgba(0,0,0,.48);
